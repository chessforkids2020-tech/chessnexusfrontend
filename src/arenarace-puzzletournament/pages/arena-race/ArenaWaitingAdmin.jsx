              ...
              {roomData.players.map((player, index) => (
                <div key={player.username} style={styles.playerCard}>
                  <div style={styles.playerAvatar}>
                    {player.displayName ? player.displayName.charAt(0).toUpperCase() : player.username.charAt(0).toUpperCase()}
                  </div>
                  <div style={styles.playerInfo}>
                    <div style={styles.playerName}>{player.displayName || player.username}</div>
