...
const S = {
  ...
  card: {
    position: 'relative',
    background: '#0f172a', border: '1px solid rgba(6,182,212,0.28)',
  ...
  dayLabel: { fontSize: 14, color: '#94a3b8', fontWeight: 600 },
  dots: { display: 'flex', gap: 7, justifyContent: 'center', margin: '12px 0 14px' },
  dot: {
    width: 9, height: 9, borderRadius: '50%',
    background: 'rgba(148,163,184,0.28)',
  },
  dotOn: { background: 'linear-gradient(135deg, #06b6d4, #10b981)' },
  title: { margin: '0 0 6px', fontSize: 20, fontWeight: 800, color: '#f8fafc' },
  sub: { margin: '0 0 18px', fontSize: 13.5, lineHeight: 1.55, color: '#94a3b8' },
  ...
  row: {
    ...
    color: '#e2e8f0', textDecoration: 'none', fontSize: 13.5,
  },
  rowDone: { color: '#34d399' },
  rowIc: { width: 20, textAlign: 'center' },
  rowText: { flex: 1 },
  note: { fontStyle: 'normal', color: '#64748b', fontSize: 12.5 },
  count: { fontVariantNumeric: 'tabular-nums', fontWeight: 700, color: '#94a3b8' },
  countDone: { color: '#34d399' },

  foot: { margin: '0 0 14px', fontSize: 12, lineHeight: 1.5, color: '#64748b' },
  footWarn: { color: '#fbbf24' },
  link: { color: '#22d3ee', fontWeight: 700, textDecoration: 'none' },
  primary: {
