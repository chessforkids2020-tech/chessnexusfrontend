...
const s = {
  fab: { position: 'fixed', right: 20, bottom: 20, width: 56, height: 56, borderRadius: 'var(--radius-circle)',
  ...
  badge: { position: 'absolute', top: -2, right: -2, minWidth: 20, height: 20, borderRadius: 'var(--radius-pill)',
  ...
  panel: { position: 'fixed', right: 20, bottom: 86, width: 340, maxWidth: 'calc(100vw - 40px)', height: 460, maxHeight: '70vh',
    ...
    borderRadius: 'var(--radius-xl)', overflow: 'hidden', zIndex: 9000, boxShadow: '0 20px 60px var(--color-black-a65)',
  ...
  blockBtn: { padding: '5px 10px', borderRadius: 'var(--radius-md)', border: '1px solid var(--color-white-a13)', background: 'var(--color-white-a07)', color: 'var(--color-text)', fontSize: 12, fontWeight: 700, cursor: 'pointer' },
  ...
  bubble: { background: 'var(--color-white-a07)', color: 'var(--color-text)', padding: '7px 11px', borderRadius: 'var(--radius-lg)', fontSize: 13.5, lineHeight: 1.4, wordBreak: 'break-word', whiteSpace: 'pre-wrap' },
  ...
  input: { flex: 1, padding: '10px 12px', borderRadius: 'var(--radius-md)', border: '1px solid var(--color-white-a13)',
  ...
  sendBtn: { padding: '10px 16px', borderRadius: 'var(--radius-md)', border: 'none', background: 'var(--color-accent-a20)', color: 'var(--color-accent)', fontWeight: 700, cursor: 'pointer' },
