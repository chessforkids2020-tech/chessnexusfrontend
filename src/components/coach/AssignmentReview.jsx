...
const S = {
  ...
  modal: { width: '100%', maxWidth: 940, maxHeight: '94vh', overflowY: 'auto', background: '#0b111a', border: '1px solid rgba(255,255,255,0.10)', borderRadius: 'var(--radius-xl)', padding: 18 },
  ...
  navBtn: { padding: '4px 10px', borderRadius: 'var(--radius-md)', border: '1px solid rgba(255,255,255,0.12)', background: 'rgba(255,255,255,0.05)', color: '#cbd5e1', cursor: 'pointer', fontSize: 12 },
  ...
  item: { textAlign: 'left', padding: '7px 10px', borderRadius: 'var(--radius-md)', border: '1px solid rgba(255,255,255,0.10)', background: 'rgba(255,255,255,0.04)', color: '#cbd5e1', cursor: 'pointer', fontSize: 12.5 },
  ...
  student: { display: 'flex', justifyContent: 'space-between', gap: 8, padding: '7px 10px', borderRadius: 'var(--radius-md)', border: '1px solid rgba(255,255,255,0.10)', background: 'rgba(255,255,255,0.04)', color: '#cbd5e1', cursor: 'pointer', fontSize: 12.5 },
  ...
  move: { padding: '3px 9px', borderRadius: 'var(--radius-sm)', border: '1px solid rgba(255,255,255,0.12)', background: 'rgba(255,255,255,0.05)', color: '#e6e8ee', cursor: 'pointer', fontSize: 12, fontFamily: 'monospace' },
  moveOn: { borderColor: 'rgba(6,182,212,0.6)', background: 'rgba(6,182,212,0.18)', color: '#67e8f9' },
  answerChip: { padding: '3px 9px', borderRadius: 'var(--radius-sm)', background: 'rgba(16,185,129,0.12)', border: '1px solid rgba(52,211,153,0.35)', color: '#6ee7b7', fontSize: 12, fontFamily: 'monospace' },
  moveOkChip: { padding: '2px 7px', marginRight: 4, borderRadius: 'var(--radius-sm)', background: 'rgba(16,185,129,0.14)', color: '#6ee7b7', fontSize: 11.5, fontFamily: 'monospace' },
  moveNoChip: { padding: '2px 7px', marginRight: 4, borderRadius: 'var(--radius-sm)', background: 'rgba(239,68,68,0.12)', color: '#fca5a5', fontSize: 11.5, fontFamily: 'monospace' },
  try: { padding: '6px 0', borderBottom: '1px solid rgba(255,255,255,0.05)', fontSize: 12 },
  pillOk: { padding: '2px 8px', borderRadius: 'var(--radius-pill)', background: 'rgba(16,185,129,0.16)', color: '#6ee7b7', fontSize: 11, fontWeight: 700 },
  pillNo: { padding: '2px 8px', borderRadius: 'var(--radius-pill)', background: 'rgba(239,68,68,0.14)', color: '#fca5a5', fontSize: 11, fontWeight: 700 },
  muted: { color: '#94a3b8', fontSize: 12 },
  // Time spent on a puzzle. Deliberately neutral (slate, not red/green): it is
  // context for the coach, not a pass/fail signal.
  timeChip: { marginLeft: 8, padding: '2px 8px', borderRadius: 'var(--radius-pill)', background: 'rgba(148,163,184,0.14)', border: '1px solid rgba(148,163,184,0.3)', color: '#cbd5e1', fontSize: 11, fontWeight: 700, textTransform: 'none', letterSpacing: 0 },
