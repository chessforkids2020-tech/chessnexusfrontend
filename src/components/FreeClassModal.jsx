      ...
      <div style={S.modal} onClick={e => e.stopPropagation()} role="dialog" aria-modal="true">
        ...
        {done ? (
          <div style={{ textAlign: 'center', padding: '18px 4px' }}>
            ...
            {/* Set the expectation now. Classes run inside ChessNexus, so the child
                needs an account — we make it, but a parent shouldn't be surprised
                by login details arriving later. */}
            <p style={{ ...S.sub, marginTop: 10 }}>
              We'll also set up your child's free ChessNexus account and send you the
              login — there's nothing for you to install or configure.
            </p>
            <button style={S.primary} onClick={onClose}>Done</button>
          </div>
        ) : (
          <>
            <h2 style={S.title}>Your child's first chess course</h2>
            <p style={S.sub}>
              <b>ChessNexus will arrange a professional coach</b> to teach your child the
              fundamentals of chess — completely free. Classes are taught in <b>English</b>.
            </p>
