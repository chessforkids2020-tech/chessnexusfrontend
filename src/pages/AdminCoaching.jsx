...
const s = {
  ...
  tab: { padding: '8px 16px', borderRadius: 'var(--radius-md)', border: `1px solid ${C.border}`, background: '#fff', color: C.muted, cursor: 'pointer', fontWeight: 700, fontSize: 14 },
  tabOn: { background: C.accent, color: '#fff', borderColor: C.accent },
  linkBar: { display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap', padding: 12, borderRadius: 'var(--radius-md)', background: C.bg, border: `1px solid ${C.accent}33`, marginBottom: 14 },
  linkBtn: { padding: '8px 14px', background: '#fff', color: C.accent, border: `1px solid ${C.accent}`, borderRadius: 'var(--radius-md)', cursor: 'pointer', fontWeight: 700, fontSize: 13 },
  msg: { fontSize: 13, color: C.accentDark, fontWeight: 600 },
  grid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(240px, 1fr))', gap: 12 },
  card: { border: `1px solid ${C.border}`, borderRadius: 'var(--radius-lg)', padding: 14, background: '#fff', cursor: 'pointer' },
  name: { fontWeight: 800, color: C.text, fontSize: 15 },
  sub: { color: C.muted, fontSize: 12.5, marginTop: 2 },
  back: { padding: '6px 12px', border: `1px solid ${C.border}`, background: '#fff', borderRadius: 'var(--radius-md)', cursor: 'pointer', fontWeight: 600, fontSize: 13, marginBottom: 12 },
  statRow: { display: 'flex', gap: 16, flexWrap: 'wrap', margin: '10px 0' },
  stat: { background: '#f9fafb', border: `1px solid ${C.border}`, borderRadius: 'var(--radius-md)', padding: '10px 14px', minWidth: 120 },
