...
const styles = {
  ...
  card: { background: 'rgba(20,20,30,0.6)', border: '1px solid rgba(139,92,246,0.25)', borderRadius: 14, padding: 18 },
  ...
  input: { width: '100%', boxSizing: 'border-box', background: 'rgba(15,23,42,0.6)', border: '1px solid rgba(139,92,246,0.3)', borderRadius: 9, padding: '9px 11px', color: '#e2e8f0', fontSize: 14 },
  game: { background: 'rgba(0,0,0,0.2)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 10, padding: 12, margin: '10px 0' },
  ...
  primary: { background: 'linear-gradient(135deg,#06b6d4,#10b981)', color: '#0a0a0a', border: 'none', borderRadius: 10, padding: '10px 18px', fontWeight: 700, cursor: 'pointer' },
  ghost: { background: 'rgba(255,255,255,0.06)', color: '#e2e8f0', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 10, padding: '8px 14px', cursor: 'pointer', fontSize: 13 },
  err: { background: 'rgba(239,68,68,0.12)', border: '1px solid rgba(239,68,68,0.3)', color: '#fca5a5', borderRadius: 10, padding: '10px 12px', margin: '10px 0', fontSize: 14 },
  list: { display: 'flex', flexDirection: 'column', gap: 10 },
  setCard: { display: 'flex', alignItems: 'center', gap: 12, background: 'rgba(20,20,30,0.6)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 12, padding: '12px 16px' },
  ...
  tag: { fontSize: 11, fontWeight: 700, color: '#c4b5fd', background: 'rgba(139,92,246,0.18)', borderRadius: 6, padding: '2px 7px' },
  freeTag: { fontSize: 11, fontWeight: 700, color: '#6ee7b7', background: 'rgba(16,185,129,0.15)', borderRadius: 6, padding: '2px 7px', marginLeft: 6 },
  premiumTag: { fontSize: 11, fontWeight: 700, color: '#fcd34d', background: 'rgba(251,191,36,0.15)', borderRadius: 6, padding: '2px 7px', marginLeft: 6 },
};
