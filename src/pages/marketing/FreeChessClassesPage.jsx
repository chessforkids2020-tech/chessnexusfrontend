...
const STEPS = [
  { n: "1", t: "Tell us about your child", d: "Name, age, country, your WhatsApp number, and whether they already know how the pieces move. Five fields — no account, no card, nothing to install." },
  { n: "2", t: "We contact you", d: "The ChessNexus team messages you on WhatsApp to agree a class time that suits you, and to answer anything you want to ask first." },
  ...
  { n: "4", t: "They learn the basics", d: "Three classes a week, 40 minutes each, for about two weeks. By the end your child can set up the board, move every piece correctly, and play a full game." },
];
...
const FAQ = [
  {
    q: "Are the chess classes really free?",
    a: "Yes. ChessNexus arranges a professional coach to teach your child the basics of chess at no cost. There is no card, no trial, and no obligation to continue afterwards. We run these classes because we think every child should get the chance to learn chess properly.",
  },
  {
...
export default function FreeChessClassesPage() {
  ...
  const courseSchema = {
    "@context": "https://schema.org",
    "@type": "Course",
    name: "Free Beginner Chess Classes for Kids",
    description:
      "Free live beginner chess classes for children of any age, taught in English by a professional coach arranged by ChessNexus. Three 40-minute classes a week for about two weeks.",
  ...
  return (
    <FeaturePageLayout
      seo={{
        title: "Free Chess Classes for Kids — Taught by a Professional Coach",
        description:
          "ChessNexus arranges a professional coach to teach your child the basics of chess, completely free. Any age, taught in English, three 40-minute classes a week for about two weeks. No account and no card — just tell us about your child.",
        keywords:
      ...
      hero={{
        icon: "🎁",
        h1: "Free chess classes for kids",
        sub: "Tell us about your child and ChessNexus will arrange a professional coach to teach them the basics of chess — completely free, at any age, taught in English.",
    ...
    >
      ...
      <section className="mkt-section">
        <h2>Why every child should learn chess</h2>
        <p>
        ...
        <p>
          The hard part is the start. A child who is taught the basics properly goes on enjoying
          chess for years; a child who is left to work it out alone usually gives up. That is the
          part we do for free.
        </p>
      </section>
        ...
        <div className="mkt-table-wrap">
          <table className="mkt-table">
            ...
            <tbody>
              ...
              <tr><td>Account needed to ask</td><td>No</td></tr>
      ...
      <section className="mkt-section">
        <h2>Book your child's free class</h2>
        <p>
