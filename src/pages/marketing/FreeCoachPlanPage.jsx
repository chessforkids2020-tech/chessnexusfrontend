...
const LIMITS = [
  { t: "21st student", d: "The roster stops at 30. To add more you move to a paid plan — Pro raises it to 70 and Coach to 150." },
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Up to 30 active students at once. Batches are unlimited, so you can organise those 30 students into as many class groups as you need. Paid plans raise the cap to 70 (Pro) or 150 (Coach).",
  },
  {
  ...
  },
  {
    ...
    a: "Six: the roster stops at 30 students; one live class per calendar day; each class is capped at 40 minutes; a live room holds 4 students plus the coach; courses are capped at 30 with up to 3 lessons each; and creating unlimited Team Race and Monthly Focus events is reserved for the paid plans, though any coach may create one Monthly Focus once for free. Nothing else is limited.",
  },
  {
