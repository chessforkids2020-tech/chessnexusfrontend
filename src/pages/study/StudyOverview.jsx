    ...
    <div style={styles.page}>
      ...
      <div style={styles.container}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 16, marginBottom: 32 }}>
          {/* NOTE: the Beginners Academy card used to sit here, disabled with a
              "Coming Soon" badge. Removed — the module is not ready and a
              permanently greyed-out tile is just clutter on the page.

              The lesson code and its /study/beginners route are untouched, so
              putting the card back is only a matter of restoring this block. */}
