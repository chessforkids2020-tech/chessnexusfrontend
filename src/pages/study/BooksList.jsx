...
const styles = {
  ...
  card: { background: 'var(--color-white-a04)', borderRadius: 12, overflow: 'hidden', border: '1px solid var(--color-white-a07)', cursor: 'pointer', display: 'flex', flexDirection: 'column' },
  coverWrap: { position: 'relative' },
  freeBadge: { position: 'absolute', top: 8, left: 8, zIndex: 1, background: 'var(--color-success)', color: 'var(--color-text)', fontSize: 11, fontWeight: 800, letterSpacing: 0.5, padding: '3px 8px', borderRadius: 6, boxShadow: '0 2px 6px var(--color-black-a35)' },
  priceBadge: { position: 'absolute', top: 8, right: 8, zIndex: 1, background: 'linear-gradient(135deg, var(--color-accent-2), var(--color-accent))', color: 'var(--color-text)', fontSize: 11, fontWeight: 800, padding: '3px 8px', borderRadius: 6, boxShadow: '0 2px 6px var(--color-black-a35)' },
  unlockedBadge: { position: 'absolute', top: 8, right: 8, zIndex: 1, background: 'var(--color-surface)', color: 'var(--color-accent-2)', border: '1px solid rgba(124,58,237,0.5)', fontSize: 11, fontWeight: 800, padding: '3px 8px', borderRadius: 6, boxShadow: '0 2px 6px var(--color-black-a35)' },
