      ...
      <div style={st.inner}>
        ...
        <button
          ...
          style={{
            ...
            margin: '0 0 16px', padding: '14px 18px', borderRadius: 'var(--radius-lg)',
...
const st = {
  ...
  playerCard: { flex: '1 1 180px', maxWidth: 240, background: C.glass, backdropFilter: 'blur(14px)', WebkitBackdropFilter: 'blur(14px)', border: `1px solid ${C.border}`, borderRadius: 'var(--radius-xl)', padding: '18px 16px', cursor: 'pointer', textAlign: 'center', color: C.text, transition: 'transform 150ms ease, border-color 150ms ease', boxShadow: '0 8px 30px var(--color-black-a35)' },
  playerPhoto: { width: 150, height: 150, borderRadius: 'var(--radius-lg)', overflow: 'hidden', background: 'var(--color-white-a07)', border: `1px solid ${C.border}`, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 12px' },
  ...
  exploreBar: { background: C.glass, backdropFilter: 'blur(14px)', WebkitBackdropFilter: 'blur(14px)', border: `1px solid ${C.border}`, borderRadius: 'var(--radius-xl)', padding: 16, marginBottom: 24, boxShadow: '0 8px 30px var(--color-black-a35)' },
  ...
  input: { padding: '9px 12px', borderRadius: 'var(--radius-md)', border: `1px solid ${C.border}`, fontSize: 14, minWidth: 160, background: C.glassSolid, color: C.text, outline: 'none' },
  select: { padding: '9px 12px', borderRadius: 'var(--radius-md)', border: `1px solid ${C.border}`, fontSize: 14, background: C.glassSolid, color: C.text, maxWidth: 200, outline: 'none' },
  searchBtn: { padding: '9px 18px', borderRadius: 'var(--radius-md)', border: `1px solid ${C.borderStrong}`, background: 'var(--color-accent-2-a15)', color: C.accent, fontWeight: 700, cursor: 'pointer', fontSize: 14 },
  suggestBox: { position: 'absolute', top: '100%', left: 0, right: 0, background: C.glassSolid, border: `1px solid ${C.borderStrong}`, borderRadius: 'var(--radius-md)', marginTop: 4, zIndex: 20, maxHeight: 240, overflowY: 'auto', boxShadow: '0 12px 30px var(--color-black-a50)', minWidth: 200 },
  suggestItem: { padding: '9px 12px', cursor: 'pointer', fontSize: 14, color: C.text },

  statsStrip: { display: 'flex', gap: 12, flexWrap: 'wrap' },
  stat: { flex: '1 1 140px', background: C.glass, backdropFilter: 'blur(14px)', WebkitBackdropFilter: 'blur(14px)', border: `1px solid ${C.border}`, borderRadius: 'var(--radius-lg)', padding: '16px 18px', textAlign: 'center', boxShadow: '0 8px 30px var(--color-black-a35)' },
