...
function AdminTeamRace() {
  ...
  const [newRace, setNewRace] = useState({
    ...
    topic: '',
    pointsPerPuzzle: 10,
    puzzlesPerPosition: 500, // Same puzzle count for all positions
    scheduledStartTime: '',
    botCount: 0
  });
            ...
            <form onSubmit={handleCreateRace}>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder="500"
                />
                <small>All positions will receive the same number of unique puzzles (e.g., 500 puzzles per position)</small>
              </div>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={e => setNewRace({ ...newRace, botCount: Math.min(10, Math.max(0, parseInt(e.target.value) || 0)) })}
                  min="0"
                  max="10"
                  placeholder="0"
                />
