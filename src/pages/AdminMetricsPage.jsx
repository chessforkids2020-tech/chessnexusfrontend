...
const pageStyles = {
  ...
  button: { padding: '10px 16px', background: '#0b6623', color: '#fff', border: 'none', borderRadius: 'var(--radius-md)', cursor: 'pointer', fontSize: 14, fontWeight: 700 },
  cardGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 14, marginTop: 20 },
  card: { background: '#fff', padding: 18, borderRadius: 'var(--radius-lg)', border: '1px solid #e6f1e6', boxShadow: '0 12px 32px rgba(0,0,0,0.05)', cursor: 'pointer', transition: 'transform 0.2s ease, box-shadow 0.2s ease' },
  ...
  historyPanel: { flex: '0 0 30%', minWidth: 280, background: '#f8fafc', padding: 18, borderRadius: 'var(--radius-lg)', border: '1px solid #d1fae6', boxShadow: '0 8px 20px rgba(15, 23, 42, 0.06)' },
  ...
  panel: { background: '#fff', padding: 20, borderRadius: 'var(--radius-lg)', border: '1px solid #e6f1e6', boxShadow: '0 10px 28px rgba(0,0,0,0.04)' },
  ...
  pill: { padding: '8px 14px', borderRadius: 'var(--radius-pill)', border: '1px solid #d1fae5', background: '#ecfdf5', color: '#0f766e', fontWeight: 700, fontSize: 13 },
  toggleGroup: { display: 'flex', gap: 10, flexWrap: 'wrap' },
  toggleButton: { padding: '8px 14px', borderRadius: 'var(--radius-md)', border: '1px solid #d1d5db', background: '#fff', color: '#374151', cursor: 'pointer' },
  toggleButtonActive: { padding: '8px 14px', borderRadius: 'var(--radius-md)', border: '1px solid #0b6623', background: '#0b6623', color: '#fff', cursor: 'pointer' },
  historyButton: { padding: '8px 16px', borderRadius: 'var(--radius-md)', border: 'none', background: '#2563eb', color: '#fff', cursor: 'pointer', fontWeight: 700 },
  summaryGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 12 },
  summaryCard: { background: '#f8fafc', padding: 16, borderRadius: 'var(--radius-lg)', border: '1px solid #dbeafe' },
