        ...
        <div className="hp-freeclass">
          <div className="hp-fc-tx">
            ...
            <h2 className="hp-fc-title">
              Every kid should learn chess — we'll teach the basics <em>free</em>.
            </h2>
            <p className="hp-fc-sub">
              ...
              teach them the basics — at no cost, whatever their age. Classes are taught in <b>English</b>.
            </p>
            ...
            <div className="hp-fc-trust">
              ...
              <span>✓ No account needed</span><span>•</span>
